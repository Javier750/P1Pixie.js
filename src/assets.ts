...
export const assets = [
    ...
    {url: "./Animaciones/Zombie/Correr/Run1.png", name: "ZRun1"},
    {url: "./Animaciones/Zombie/Correr/Run2.png", name: "ZRun2"},
    {url: "./Animaciones/Zombie/Correr/Run3.png", name: "ZRun3"},
    {url: "./Animaciones/Zombie/Correr/Run4.png", name: "ZRun4"},
    {url: "./Animaciones/Zombie/Correr/Run5.png", name: "ZRun5"},
    {url: "./Animaciones/Zombie/Correr/Run6.png", name: "ZRun6"},
